...
void CFrustum::ElementStiffness(double* Matrix)
{
	...
	Matrix[10] = (h*k*3.141592653589793*((C*C)*(l*l*l*l)*2.0 + (S*S)*(l*l)*6.7E1 + (h*h)*(r*r)*7.0E1 + C*S*(l*l*l)*9.0)*(1.0 / 1.05E2)) / (l*r);
	Matrix[12] = -S*(h*k*3.141592653589793*(S*nu*1.5E1 + C*l*nu*5.0)*(1.0 / 3.0E1) - (h*k*3.141592653589793*((S*S)*l + C*S*(l*l)*3.0)*(1.0 / 3.0E1)) / r) + (C*h*k*1.0 / (l*l)*3.141592653589793*((C*C)*(l*l*l*l)*2.2E1 + (S*S)*(l*l)*1.68E2 + (h*h)*(r*r)*2.1E2 + C*S*(l*l*l)*3.9E1)*(1.0 / 2.1E2)) / r;
	Matrix[14] = -C*(h*k*3.141592653589793*(S*nu*1.5E1 + C*l*nu*5.0)*(1.0 / 3.0E1) - (h*k*3.141592653589793*((S*S)*l + C*S*(l*l)*3.0)*(1.0 / 3.0E1)) / r) - (S*h*k*1.0 / (l*l)*3.141592653589793*((C*C)*(l*l*l*l)*2.2E1 + (S*S)*(l*l)*1.68E2 + (h*h)*(r*r)*2.1E2 + C*S*(l*l*l)*3.9E1)*(1.0 / 2.1E2)) / r;
	...
	Matrix[23] = C*(h*k*3.141592653589793*(S*nu*1.5E1 + C*l*nu*5.0)*(1.0 / 3.0E1) + (h*k*3.141592653589793*((S*S)*l*1.4E1 + C*S*(l*l)*2.0)*(1.0 / 3.0E1)) / r) + (S*h*k*3.141592653589793*((S*S)*l*1.68E2 - (C*C)*(l*l*l)*1.3E1 + (h*h)*(r*r)*2.1E2 - C*S*(l*l)*6.6E1)*(1.0 / 2.1E2)) / (l*r);
	...
	Matrix[40] = S*(h*k*3.141592653589793*(S*nu*1.5E1 + C*l*nu*5.0)*(1.0 / 3.0E1) + (h*k*3.141592653589793*((S*S)*l*1.4E1 + C*S*(l*l)*2.0)*(1.0 / 3.0E1)) / r) - (C*h*k*3.141592653589793*((S*S)*l*1.68E2 - (C*C)*(l*l*l)*1.3E1 + (h*h)*(r*r)*2.1E2 - C*S*(l*l)*6.6E1)*(1.0 / 2.1E2)) / (l*r);
	...
	Matrix[61] = (h*k*3.141592653589793*((C*C)*(l*l*l*l)*3.0 + (S*S)*(l*l)*1.4E1 - (h*h)*(r*r)*7.0E1 + C*S*(l*l*l)*1.2E1)*(-1.0 / 2.1E2)) / (l*r);
