...
void CHex::ElementStiffness(double* Matrix)
{
	...
	for (unsigned p = 0; p < 8; p++)
	{
		...
		Matrix[190] += detJ*(D[0] * (kerB[19] * kerB[19]) + D[2] * (kerB[18] * kerB[18]) + D[2] * (kerB[20] * kerB[20]));
		Matrix[191] += detJ*(D[1] * kerB[18] * kerB[19] + D[2] * kerB[18] * kerB[19]);
		Matrix[192] += detJ*(D[1] * kerB[17] * kerB[19] + D[2] * kerB[16] * kerB[20]);
		Matrix[193] += detJ*(D[0] * kerB[16] * kerB[19] + D[2] * kerB[15] * kerB[18] + D[2] * kerB[17] * kerB[20]);
		Matrix[194] += detJ*(D[1] * kerB[15] * kerB[19] + D[2] * kerB[16] * kerB[18]);
		Matrix[195] += detJ*(D[1] * kerB[14] * kerB[19] + D[2] * kerB[13] * kerB[20]);
		Matrix[196] += detJ*(D[0] * kerB[13] * kerB[19] + D[2] * kerB[12] * kerB[18] + D[2] * kerB[14] * kerB[20]);
		Matrix[197] += detJ*(D[1] * kerB[12] * kerB[19] + D[2] * kerB[13] * kerB[18]);
		Matrix[198] += detJ*(D[1] * kerB[11] * kerB[19] + D[2] * kerB[10] * kerB[20]);
		Matrix[199] += detJ*(D[0] * kerB[10] * kerB[19] + D[2] * kerB[9] * kerB[18] + D[2] * kerB[11] * kerB[20]);
		Matrix[200] += detJ*(D[1] * kerB[9] * kerB[19] + D[2] * kerB[10] * kerB[18]);
		Matrix[201] += detJ*(D[1] * kerB[8] * kerB[19] + D[2] * kerB[7] * kerB[20]);
		Matrix[202] += detJ*(D[0] * kerB[7] * kerB[19] + D[2] * kerB[6] * kerB[18] + D[2] * kerB[8] * kerB[20]);
		Matrix[203] += detJ*(D[1] * kerB[6] * kerB[19] + D[2] * kerB[7] * kerB[18]);
		Matrix[204] += detJ*(D[1] * kerB[5] * kerB[19] + D[2] * kerB[4] * kerB[20]);
		Matrix[205] += detJ*(D[0] * kerB[4] * kerB[19] + D[2] * kerB[3] * kerB[18] + D[2] * kerB[5] * kerB[20]);
		Matrix[206] += detJ*(D[1] * kerB[3] * kerB[19] + D[2] * kerB[4] * kerB[18]);
		Matrix[207] += detJ*(D[1] * kerB[2] * kerB[19] + D[2] * kerB[1] * kerB[20]);
		Matrix[208] += detJ*(D[0] * kerB[1] * kerB[19] + D[2] * kerB[0] * kerB[18] + D[2] * kerB[2] * kerB[20]);
		Matrix[209] += detJ*(D[1] * kerB[0] * kerB[19] + D[2] * kerB[1] * kerB[18]);
		...
		Matrix[233] += detJ*(D[1] * kerB[19] * kerB[21] + D[2] * kerB[18] * kerB[22]);
		...
		Matrix[256] += detJ*(D[0] * kerB[19] * kerB[22] + D[2] * kerB[18] * kerB[21] + D[2] * kerB[20] * kerB[23]);
...
void  CHex::ElementStress2(double* stress, double* Displacement , double* PrePositions, double* PostPositions)
{
}