...
//	Calculate element stiffness matrix
    ...
    for (unsigned i=0 ; i<2 ;i++){
        for (unsigned j=0; j<2 ; j++){
            ...
            Matrix[1]+=Je*(B[0][0]*B[1][0]*(D[1]+D[3]));
            Matrix[2]+=Je*(B[1][0]*B[1][0]*D[2]+B[0][0]*B[0][0]*D[3]);
            Matrix[3]+=Je*(B[0][0]*B[0][1]*D[0]+B[1][0]*B[1][1]*D[3]);
            Matrix[4]+=Je*(B[1][0]*B[0][1]*D[1]+B[0][0]*B[1][1]*D[3]);
            Matrix[5]+=Je*(B[0][1]*B[0][1]*D[0]+B[1][1]*B[1][1]*D[3]);
            Matrix[6]+=Je*(B[0][0]*B[1][1]*D[1]+B[1][0]*B[0][1]*D[3]);
            Matrix[7]+=Je*(B[1][0]*B[1][1]*D[2]+B[0][0]*B[0][1]*D[3]);
            Matrix[8]+=Je*(B[0][1]*B[1][1]*D[1]+B[1][1]*B[0][1]*D[3]);
            Matrix[9]+=Je*(B[1][1]*B[1][1]*D[2]+B[0][1]*B[0][1]*D[3]);
            Matrix[10]+=Je*(B[0][0]*B[0][2]*D[0]+B[1][0]*B[1][2]*D[3]);
            Matrix[11]+=Je*(B[1][0]*B[0][2]*D[1]+B[0][0]*B[1][2]*D[3]);
            Matrix[12]+=Je*(B[0][1]*B[0][2]*D[0]+B[1][1]*B[1][2]*D[3]);
            Matrix[13]+=Je*(B[1][1]*B[0][2]*D[1]+B[0][1]*B[1][2]*D[3]);
            Matrix[14]+=Je*(B[0][2]*B[0][2]*D[0]+B[1][2]*B[1][2]*D[3]);
            Matrix[15]+=Je*(B[0][0]*B[1][2]*D[1]+B[1][0]*B[0][2]*D[3]);
            Matrix[16]+=Je*(B[1][0]*B[1][2]*D[2]+B[0][0]*B[0][2]*D[3]);
            Matrix[17]+=Je*(B[0][1]*B[1][2]*D[1]+B[1][1]*B[0][2]*D[3]);
            Matrix[18]+=Je*(B[1][1]*B[1][2]*D[2]+B[0][1]*B[0][2]*D[3]);
            Matrix[19]+=Je*(B[0][2]*B[1][2]*D[1]+B[1][2]*B[0][2]*D[3]);
            Matrix[20]+=Je*(B[1][2]*B[1][2]*D[2]+B[0][2]*B[0][2]*D[3]);
            Matrix[21]+=Je*(B[0][0]*B[0][3]*D[0]+B[1][0]*B[1][3]*D[3]);
            Matrix[22]+=Je*(B[1][0]*B[0][3]*D[1]+B[0][0]*B[1][3]*D[3]);
            Matrix[23]+=Je*(B[0][1]*B[0][3]*D[0]+B[1][1]*B[1][3]*D[3]);
            Matrix[24]+=Je*(B[1][1]*B[0][3]*D[1]+B[0][1]*B[1][3]*D[3]);
            Matrix[25]+=Je*(B[0][2]*B[0][3]*D[0]+B[1][2]*B[1][3]*D[3]);
            Matrix[26]+=Je*(B[1][2]*B[0][3]*D[1]+B[0][2]*B[1][3]*D[3]);
            Matrix[27]+=Je*(B[0][3]*B[0][3]*D[0]+B[1][3]*B[1][3]*D[3]);
            Matrix[28]+=Je*(B[0][0]*B[1][3]*D[1]+B[1][0]*B[0][3]*D[3]);
            Matrix[29]+=Je*(B[1][0]*B[1][3]*D[2]+B[0][0]*B[0][3]*D[3]);
            Matrix[30]+=Je*(B[0][1]*B[1][3]*D[1]+B[1][1]*B[0][3]*D[3]);
            Matrix[31]+=Je*(B[1][1]*B[1][3]*D[2]+B[0][1]*B[0][3]*D[3]);
            Matrix[32]+=Je*(B[0][2]*B[1][3]*D[1]+B[1][2]*B[0][3]*D[3]);
            Matrix[33]+=Je*(B[1][2]*B[1][3]*D[2]+B[0][2]*B[0][3]*D[3]);
            Matrix[34]+=Je*(B[0][3]*B[1][3]*D[1]+B[1][3]*B[0][3]*D[3]);
            Matrix[35]+=Je*(B[1][3]*B[1][3]*D[2]+B[0][3]*B[0][3]*D[3]);
        }
    }
}
