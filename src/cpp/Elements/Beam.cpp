...
//	Calculate beam length
	...
	double Iz = (material->a*material->a*material->a)*material->b/12-pow(-material->a+material->t1+material->t3,3.0)*(-material->b+material->t2+material->t4)/12;
	double Iy = (material->b*material->b*material->b)*material->a/12-pow(-material->b+material->t2+material->t4,3.0)*(-material->a+material->t1+material->t3)/12;
	double Ip = Iz+Iy;
