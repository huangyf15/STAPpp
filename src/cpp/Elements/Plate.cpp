...
void CPlate::ElementStiffness(double* Matrix)
{
	...
	MatrixLit[8] = k*(1/(2*(yeta*yeta*yeta)) - ((2*nu)/5 + 0.1)/((xpsi*xpsi)*yeta));
	...
	MatrixLit[14] = k*(1/(2*(yeta*yeta*yeta)) - ((2*nu)/5 + 0.1)/((xpsi*xpsi)*yeta));
	...
	MatrixLit[22] = k*(1/(2*(xpsi*xpsi*xpsi)) - ((2*nu)/5 + 0.1)/(xpsi*(yeta*yeta)));
	...
	MatrixLit[25] = (k*((xpsi*xpsi)*(nu/10 - 0.1) + (yeta*yeta)/2))/((xpsi*xpsi*xpsi)*(yeta*yeta));
	MatrixLit[26] = -k*(1/(2*(yeta*yeta*yeta)) + (nu/10 - 0.1)/((xpsi*xpsi)*yeta));
	...
	MatrixLit[35] = (k*((yeta*yeta)*(nu/10 - 0.1) + (xpsi*xpsi)/2))/((xpsi*xpsi)*(yeta*yeta*yeta));
	...
	MatrixLit[40] = 0;
	MatrixLit[41] = k*(1/(2*(xpsi*xpsi*xpsi)) - ((2*nu)/5 + 0.1)/(xpsi*(yeta*yeta)));
	MatrixLit[42] = -k*((3*nu - 3)/(45*(yeta*yeta)) - 1/(3*(xpsi*xpsi)));
	MatrixLit[43] = 0;
	MatrixLit[44] = -k*(1/(2*(xpsi*xpsi*xpsi)) + (nu/10 - 0.1)/(xpsi*(yeta*yeta)));
	...
	MatrixLit[47] = (k*((yeta*yeta)*((2*nu)/5 + 0.1) - (xpsi*xpsi)/2))/((xpsi*xpsi)*(yeta*yeta*yeta));
	...
	MatrixLit[49] = -k*(1/(2*(xpsi*xpsi*xpsi)) + (nu/10 - 0.1)/(xpsi*(yeta*yeta)));
	MatrixLit[50] = -k*(1/(2*(yeta*yeta*yeta)) + (nu/10 - 0.1)/((xpsi*xpsi)*yeta));
	...
	MatrixLit[52] = (k*((xpsi*xpsi)*((2*nu)/5 + 0.1) - (yeta*yeta)/2))/((xpsi*xpsi*xpsi)*(yeta*yeta));
	...
	MatrixLit[59] = (k*((yeta*yeta)*((2*nu)/5 + 0.1) - (xpsi*xpsi)/2))/((xpsi*xpsi)*(yeta*yeta*yeta));
	MatrixLit[60] = 0;
	MatrixLit[61] = -k*((nu/15 - 0.0666666666666667)/(xpsi*xpsi) - 1/(3*(yeta*yeta)));
	MatrixLit[62] = (k*((yeta*yeta)*(nu/10 - 0.1) + (xpsi*xpsi)/2))/((xpsi*xpsi)*(yeta*yeta*yeta));
	MatrixLit[63] = 0;
	...
	MatrixLit[73] = 0;
	MatrixLit[74] = (k*((xpsi*xpsi)*(nu/10 - 0.1) + (yeta*yeta)/2))/((xpsi*xpsi*xpsi)*(yeta*yeta));
	MatrixLit[75] = k*((4*(nu - 1))/(15*(yeta*yeta)) + 2/(3*(xpsi*xpsi)));
	MatrixLit[76] = 0;
	MatrixLit[77] = (k*((xpsi*xpsi)*((2*nu)/5 + 0.1) - (yeta*yeta)/2))/((xpsi*xpsi*xpsi)*(yeta*yeta));
...
Matrix[15] = MatrixLit[1] * xdir[2]*xdir[2] + MatrixLit[4] * xdir[2]*ydir[2] + MatrixLit[4] * ydir[2]*xdir[2] + MatrixLit[3] * ydir[2]*ydir[2];
Matrix[16] = MatrixLit[1] * xdir[1]*xdir[2] + MatrixLit[4] * xdir[1]*ydir[2] + MatrixLit[4] * ydir[1]*xdir[2] + MatrixLit[3] * ydir[1]*ydir[2];
Matrix[17] = MatrixLit[1] * xdir[0]*xdir[2] + MatrixLit[4] * xdir[0]*ydir[2] + MatrixLit[4] * ydir[0]*xdir[2] + MatrixLit[3] * ydir[0]*ydir[2];
...
Matrix[49] = MatrixLit[13] * xdir[2]*xdir[0] + MatrixLit[19] * xdir[2]*ydir[0] + MatrixLit[12] * ydir[2]*xdir[0] + MatrixLit[18] * ydir[2]*ydir[0];
...
Matrix[60] = MatrixLit[13] * xdir[2]*xdir[1] + MatrixLit[19] * xdir[2]*ydir[1] + MatrixLit[12] * ydir[2]*xdir[1] + MatrixLit[18] * ydir[2]*ydir[1];
...
Matrix[66] = MatrixLit[10] * xdir[2]*xdir[2] + MatrixLit[16] * xdir[2]*ydir[2] + MatrixLit[16] * ydir[2]*xdir[2] + MatrixLit[15] * ydir[2]*ydir[2];
Matrix[67] = MatrixLit[10] * xdir[1]*xdir[2] + MatrixLit[16] * xdir[1]*ydir[2] + MatrixLit[16] * ydir[1]*xdir[2] + MatrixLit[15] * ydir[1]*ydir[2];
Matrix[68] = MatrixLit[10] * xdir[0]*xdir[2] + MatrixLit[16] * xdir[0]*ydir[2] + MatrixLit[16] * ydir[0]*xdir[2] + MatrixLit[15] * ydir[0]*ydir[2];
...
Matrix[72] = MatrixLit[13] * xdir[2]*xdir[2] + MatrixLit[19] * xdir[2]*ydir[2] + MatrixLit[12] * ydir[2]*xdir[2] + MatrixLit[18] * ydir[2]*ydir[2];
Matrix[73] = MatrixLit[13] * xdir[1]*xdir[2] + MatrixLit[19] * xdir[1]*ydir[2] + MatrixLit[12] * ydir[1]*xdir[2] + MatrixLit[18] * ydir[1]*ydir[2];
Matrix[74] = MatrixLit[13] * xdir[0]*xdir[2] + MatrixLit[19] * xdir[0]*ydir[2] + MatrixLit[12] * ydir[0]*xdir[2] + MatrixLit[18] * ydir[0]*ydir[2];
...
Matrix[124] = MatrixLit[31] * xdir[2]*xdir[0] + MatrixLit[40] * xdir[2]*ydir[0] + MatrixLit[30] * ydir[2]*xdir[0] + MatrixLit[39] * ydir[2]*ydir[0];
...
Matrix[130] = MatrixLit[34] * xdir[2]*xdir[0] + MatrixLit[43] * xdir[2]*ydir[0] + MatrixLit[33] * ydir[2]*xdir[0] + MatrixLit[42] * ydir[2]*ydir[0];
...
Matrix[141] = MatrixLit[31] * xdir[2]*xdir[1] + MatrixLit[40] * xdir[2]*ydir[1] + MatrixLit[30] * ydir[2]*xdir[1] + MatrixLit[39] * ydir[2]*ydir[1];
...
Matrix[147] = MatrixLit[34] * xdir[2]*xdir[1] + MatrixLit[43] * xdir[2]*ydir[1] + MatrixLit[33] * ydir[2]*xdir[1] + MatrixLit[42] * ydir[2]*ydir[1];
...
Matrix[153] = MatrixLit[28] * xdir[2]*xdir[2] + MatrixLit[37] * xdir[2]*ydir[2] + MatrixLit[37] * ydir[2]*xdir[2] + MatrixLit[36] * ydir[2]*ydir[2];
Matrix[154] = MatrixLit[28] * xdir[1]*xdir[2] + MatrixLit[37] * xdir[1]*ydir[2] + MatrixLit[37] * ydir[1]*xdir[2] + MatrixLit[36] * ydir[1]*ydir[2];
Matrix[155] = MatrixLit[28] * xdir[0]*xdir[2] + MatrixLit[37] * xdir[0]*ydir[2] + MatrixLit[37] * ydir[0]*xdir[2] + MatrixLit[36] * ydir[0]*ydir[2];
...
Matrix[159] = MatrixLit[31] * xdir[2]*xdir[2] + MatrixLit[40] * xdir[2]*ydir[2] + MatrixLit[30] * ydir[2]*xdir[2] + MatrixLit[39] * ydir[2]*ydir[2];
Matrix[160] = MatrixLit[31] * xdir[1]*xdir[2] + MatrixLit[40] * xdir[1]*ydir[2] + MatrixLit[30] * ydir[1]*xdir[2] + MatrixLit[39] * ydir[1]*ydir[2];
Matrix[161] = MatrixLit[31] * xdir[0]*xdir[2] + MatrixLit[40] * xdir[0]*ydir[2] + MatrixLit[30] * ydir[0]*xdir[2] + MatrixLit[39] * ydir[0]*ydir[2];
...
Matrix[165] = MatrixLit[34] * xdir[2]*xdir[2] + MatrixLit[43] * xdir[2]*ydir[2] + MatrixLit[33] * ydir[2]*xdir[2] + MatrixLit[42] * ydir[2]*ydir[2];
Matrix[166] = MatrixLit[34] * xdir[1]*xdir[2] + MatrixLit[43] * xdir[1]*ydir[2] + MatrixLit[33] * ydir[1]*xdir[2] + MatrixLit[42] * ydir[1]*ydir[2];
Matrix[167] = MatrixLit[34] * xdir[0]*xdir[2] + MatrixLit[43] * xdir[0]*ydir[2] + MatrixLit[33] * ydir[0]*xdir[2] + MatrixLit[42] * ydir[0]*ydir[2];
...
Matrix[235] = MatrixLit[58] * xdir[2]*xdir[0] + MatrixLit[70] * xdir[2]*ydir[0] + MatrixLit[57] * ydir[2]*xdir[0] + MatrixLit[69] * ydir[2]*ydir[0];
...
Matrix[241] = MatrixLit[61] * xdir[2]*xdir[0] + MatrixLit[73] * xdir[2]*ydir[0] + MatrixLit[60] * ydir[2]*xdir[0] + MatrixLit[72] * ydir[2]*ydir[0];
...
Matrix[247] = MatrixLit[64] * xdir[2]*xdir[0] + MatrixLit[76] * xdir[2]*ydir[0] + MatrixLit[63] * ydir[2]*xdir[0] + MatrixLit[75] * ydir[2]*ydir[0];
...
Matrix[258] = MatrixLit[58] * xdir[2]*xdir[1] + MatrixLit[70] * xdir[2]*ydir[1] + MatrixLit[57] * ydir[2]*xdir[1] + MatrixLit[69] * ydir[2]*ydir[1];
...
Matrix[264] = MatrixLit[61] * xdir[2]*xdir[1] + MatrixLit[73] * xdir[2]*ydir[1] + MatrixLit[60] * ydir[2]*xdir[1] + MatrixLit[72] * ydir[2]*ydir[1];
...
Matrix[270] = MatrixLit[64] * xdir[2]*xdir[1] + MatrixLit[76] * xdir[2]*ydir[1] + MatrixLit[63] * ydir[2]*xdir[1] + MatrixLit[75] * ydir[2]*ydir[1];
...
Matrix[276] = MatrixLit[55] * xdir[2]*xdir[2] + MatrixLit[67] * xdir[2]*ydir[2] + MatrixLit[67] * ydir[2]*xdir[2] + MatrixLit[66] * ydir[2]*ydir[2];
Matrix[277] = MatrixLit[55] * xdir[1]*xdir[2] + MatrixLit[67] * xdir[1]*ydir[2] + MatrixLit[67] * ydir[1]*xdir[2] + MatrixLit[66] * ydir[1]*ydir[2];
Matrix[278] = MatrixLit[55] * xdir[0]*xdir[2] + MatrixLit[67] * xdir[0]*ydir[2] + MatrixLit[67] * ydir[0]*xdir[2] + MatrixLit[66] * ydir[0]*ydir[2];
...
Matrix[282] = MatrixLit[58] * xdir[2]*xdir[2] + MatrixLit[70] * xdir[2]*ydir[2] + MatrixLit[57] * ydir[2]*xdir[2] + MatrixLit[69] * ydir[2]*ydir[2];
Matrix[283] = MatrixLit[58] * xdir[1]*xdir[2] + MatrixLit[70] * xdir[1]*ydir[2] + MatrixLit[57] * ydir[1]*xdir[2] + MatrixLit[69] * ydir[1]*ydir[2];
Matrix[284] = MatrixLit[58] * xdir[0]*xdir[2] + MatrixLit[70] * xdir[0]*ydir[2] + MatrixLit[57] * ydir[0]*xdir[2] + MatrixLit[69] * ydir[0]*ydir[2];
...
Matrix[288] = MatrixLit[61] * xdir[2]*xdir[2] + MatrixLit[73] * xdir[2]*ydir[2] + MatrixLit[60] * ydir[2]*xdir[2] + MatrixLit[72] * ydir[2]*ydir[2];
Matrix[289] = MatrixLit[61] * xdir[1]*xdir[2] + MatrixLit[73] * xdir[1]*ydir[2] + MatrixLit[60] * ydir[1]*xdir[2] + MatrixLit[72] * ydir[1]*ydir[2];
Matrix[290] = MatrixLit[61] * xdir[0]*xdir[2] + MatrixLit[73] * xdir[0]*ydir[2] + MatrixLit[60] * ydir[0]*xdir[2] + MatrixLit[72] * ydir[0]*ydir[2];
...
Matrix[294] = MatrixLit[64] * xdir[2]*xdir[2] + MatrixLit[76] * xdir[2]*ydir[2] + MatrixLit[63] * ydir[2]*xdir[2] + MatrixLit[75] * ydir[2]*ydir[2];
Matrix[295] = MatrixLit[64] * xdir[1]*xdir[2] + MatrixLit[76] * xdir[1]*ydir[2] + MatrixLit[63] * ydir[1]*xdir[2] + MatrixLit[75] * ydir[1]*ydir[2];
Matrix[296] = MatrixLit[64] * xdir[0]*xdir[2] + MatrixLit[76] * xdir[0]*ydir[2] + MatrixLit[63] * ydir[0]*xdir[2] + MatrixLit[75] * ydir[0]*ydir[2];
