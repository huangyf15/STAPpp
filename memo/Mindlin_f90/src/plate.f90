...
! N106: MTAP(NUME)
  ...
  CALL plateRUSS (IA(NP(1)),DA(NP(2)),DA(NP(3)),DA(NP(4)),IA(NP(5)),   &
...
SUBROUTINE plateRUSS (ID,X,Y,U,MHT,E,miu,h,LM,XY,MATP)
! . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .
! .                                                                   .
        ...
        DO J1=1,3
            ...
            NN0(1,8)=(1-yita(J1)*yita(J1))*(1-kesai(J2))/2
              ...
              NN(2,8)=-yita(J1)*(1.D0-kesai(J2))
                ...
                S=S+WWW(J1)*WWW(J2)*(matmul(matmul(transpose(Be1),D0*h(MTYPE)**3/12),Be1)*abs(A1*D1-B1*C1)+matmul(transpose(Be2),E(MTYPE)/(2+2*miu(MTYPE))*h(MTYPE)*Be2)*abs(A1*D1-B1*C1)*1.2)
