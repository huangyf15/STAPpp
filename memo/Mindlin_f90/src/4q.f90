...
! Allocate storage for element group data
  ...
  CALL SUBQUADS (IA(NP(1)),DA(NP(2)),DA(NP(3)),DA(NP(4)),IA(NP(5)),   &
...
SUBROUTINE SUBQUADS (ID,X,Y,U,MHT,E,POSSION,LM,XY,MATP)
! . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .
! .                                                                   .
! .   4Q element subroutine                                           .
! .                                                                   .
! . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .
  ...
  REAL(8) :: X(NUMNP),Y(NUMNP),E(NPAR(3)),POSSION(NPAR(3)),  &
             XY(8,NPAR(2)),U(NEQ)
  REAL(8) :: S(8,8),ST(3,3),GN(2,4),JAC(2,2),INVJ(2,2),BE(3,8), &
     ...
     DO N=1,NUME
        ...
        DO I=1,2
            DO J=1,2
                ...
                ! Get Jacobi matrix
                DO II=1,4
                    JAC(1,1) = JAC(1,1)+GN(1,II)*XY(2*II-1,N)
                    JAC(1,2) = JAC(1,2)+GN(1,II)*XY(2*II,N)
                    JAC(2,1) = JAC(2,1)+GN(2,II)*XY(2*II-1,N)
                    JAC(2,2) = JAC(2,2)+GN(2,II)*XY(2*II,N)
                END DO
