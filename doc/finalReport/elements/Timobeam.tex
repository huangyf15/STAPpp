...
\subsubsection{悬臂梁：用于分片试验的精确解}
    \begin{figure}[!htbp]
      ...
      \includegraphics[width=4.0in]{Timo+example.eps}\\
...
\subsubsection{分片试验结果}
    ...
    \begin{figure}[!htbp]
      \centering
      % Requires \usepackage{graphicx}
      \includegraphics[width=4.0in]{Timo+patchtest.eps}\\
    ...
    \begin{figure}[!htbp]
      \centering
      % Requires \usepackage{graphicx}
      \includegraphics[width=6.0in]{Timo+SRINT_M_0.eps}\\
    ...
    \begin{figure}[!htbp]
      \centering
      % Requires \usepackage{graphicx}
      \includegraphics[width=6.0in]{Timo+SRINT_F_0.eps}\\
    ...
    \begin{figure}[!htbp]
      \centering
      % Requires \usepackage{graphicx}
      \includegraphics[width=6.0in]{Timo+SRINT_M_1.eps}\\
    ...
    \begin{figure}[!htbp]
      \centering
      % Requires \usepackage{graphicx}
      \includegraphics[width=6.0in]{Timo+SRINT_F_1.eps}\\
    ...
    \begin{figure}[!htbp]
      \centering
      % Requires \usepackage{graphicx}
      \includegraphics[width=6.0in]{Timo+EBMOD_PATCH_M.eps}\\
    ...
    \begin{figure}[!htbp]
      \centering
      % Requires \usepackage{graphicx}
      \includegraphics[width=6.0in]{Timo+EBMOD_PATCH_F.eps}\\
...
\subsubsection{收敛率分析}
     \begin{figure}[!htbp]
      \centering
      % Requires \usepackage{graphicx}
      \includegraphics[width=6.0in]{Timo+SRINT_CONV_M.eps}\\
    ...
    \begin{figure}[!htbp]
      \centering
      % Requires \usepackage{graphicx}
      \includegraphics[width=6.0in]{Timo+SRINT_CONV_F.eps}\\
